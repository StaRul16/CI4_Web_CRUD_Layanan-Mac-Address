					...
					<div class="pd-20 card-box mb-30">
						<div class="clearfix">
							<div class="pull-left">
								...
								<p class="mb-30">Tambah Jenis Perangkat</p>
							</div>
							
						</div>
						<form action="<?= site_url('/perangkat/store') ?>" method="post">
    <div class="form-group row">
        <label class="col-sm-12 col-md-2 col-form-label" for="nama_perangkat">Nama Perangkat</label>
        <div class="col-sm-12 col-md-10">
            <input class="form-control" type="text" id="nama_perangkat" name="nama_perangkat" placeholder="Masukkan Nama Perangkat"/>
